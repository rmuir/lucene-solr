...
public class SlowDistanceQuery2 extends Query {
  final String field;
  final double latitude;
  final double longitude;
  final double radius;
  
  public SlowDistanceQuery2(String field, double latitude, double longitude, double radius) {
    this.field = field;
  ...
  public boolean equals(Object obj) {
    ...
    SlowDistanceQuery2 other = (SlowDistanceQuery2) obj;
    if (field == null) {
        ...
        return new Bits() {
          ...
          public boolean get(int doc) {
            ...
            for (int i = 0; i < count; i++) {
              long encoded = values.valueAt(i);
              double docLat = LatLonPoint.decodeLatitude((int)(encoded >> 32));
              double docLon = LatLonPoint.decodeLongitude((int)(encoded & 0xFFFFFFFF));
