...
public class TestFieldCacheReopen extends LuceneTestCase {
  ...
  public void testFieldCacheReuseAfterReopen() throws Exception {
    ...
    final NumericDocValues ints = FieldCache.DEFAULT.getLegacyNumerics(r1, "number", FieldCache.NUMERIC_UTILS_INT_PARSER, false);
    ...
    final NumericDocValues ints2 = FieldCache.DEFAULT.getLegacyNumerics(sub0, "number", FieldCache.NUMERIC_UTILS_INT_PARSER, false);
    r2.close();
